...
import { RedButton, BlueButton, WhiteButton } from './../../../components/buttonStyles';
    ...
    useEffect(() => {
        if (userDetails && userDetails.sclass_name && userDetails.sclass_name.id !== undefined) {
            dispatch(getSubjectList(userDetails.sclass_name.id, "ClassSubjects"));
        }
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {subjectMarks.map((result, index) => {
                                if (!result.sub_name || !result.marksObtained) {
                                    return null;
                                }
                                return (
                                    <StyledTableRow key={index}>
                                        <StyledTableCell>{result.sub_name.sub_name}</StyledTableCell>
                    ...
                    <div style={styles.details}>
                        ...
                        <div style={styles.info}>
                            ...
                            <div style={styles.field}>
                                ...
                                <span style={styles.value}>{userDetails.roll_num}</span>
                            </div>
                            <div style={styles.field}>
