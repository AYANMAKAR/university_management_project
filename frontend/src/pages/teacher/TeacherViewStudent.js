...
const TeacherViewStudent = () => {
    ...
    const teachSubject = currentUser.teach_subject_id?.sub_name
    const teachSubjectID = currentUser.teach_subject_id?.id
                    ...
                    {subjectMarks && Array.isArray(subjectMarks) && subjectMarks.length > 0 &&
                        <>
                            {subjectMarks.map((result, index) => {
                                if (result.sub_name.sub_name === teachSubject) {
                                    return (
                                        <Table key={index}>
                                            <TableHead>
                                                <StyledTableRow>
                                ...
                                else if (!result.sub_name || !result.marksObtained) {
                                    return null;
                                }
                                return null
                            })}
