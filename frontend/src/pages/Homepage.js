    ...
    return (
        <div>
            <Navbar style={{ backgroundColor: '#080a43', marginTop:'0%', paddingTop:'0%' }}>
                <NavBrand to="/"><img src={logo} alt="University Logo"  style={{ width: '25%',height:'50%',margin:'0%'}}/></NavBrand>
                <NavLinks>
                ...
                <FacultySection>
                    ...
                    <FacultyGrid>
                        <FacultyCard>
                            ...
                            <h3>Dr. Nabanita Mondal</h3>
                            <p>Professor of Computer Science</p>
                        </FacultyCard>
                        <FacultyCard>
                            <img src="faculty2.jpg" alt="Faculty 2" />
                            <h3>Dr. Sayan Kr. Roy</h3>
                            <p>Assistant Professor of Cyber Security</p>
                        </FacultyCard>
                        <FacultyCard>
                            <img src="faculty3.jpg" alt="Faculty 3" />
                            <h3>Dr. Kamalika Das</h3>
                            <p>Associate Professor of Data Science</p>
                        </FacultyCard>
                    </FacultyGrid>
                </FacultySection>
                </div>
